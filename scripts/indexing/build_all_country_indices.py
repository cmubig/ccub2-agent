...
class CountryIndexBuilder:
    ...
    def build_knowledge(self, country: str) -> bool:
        ...
        cmd = [
            "conda", "run", "-n", "ccub2",
            "python", str(PROJECT_ROOT / "scripts/data_processing/extract_cultural_knowledge.py"),
    ...
    def build_clip_index(self, country: str) -> bool:
        ...
        cmd = [
            "conda", "run", "-n", "ccub2",
            "python", str(PROJECT_ROOT / "scripts/indexing/build_clip_image_index.py"),
            "--country", country,
    ...
    def build_rag_index(self, country: str) -> bool:
        ...
        cmd = [
            "conda", "run", "-n", "ccub2",
            "python", str(PROJECT_ROOT / "scripts/indexing/integrate_knowledge_to_rag.py"),
